<?php
    ...
    <?php
        ...
        if(isset($_POST['Signup'])){
            ...
            $User = "SELECT * FROM `users_login` WHERE username = '$Username' OR email = '$eAddress' ";
            ...
            if(mysqli_num_rows($Qeury) > 0){
                ...
                mysqli_query($pdo, "INSERT INTO `users_login`(`id`, `email`, `username`, `phone`, `index_number`, `passwd`) VALUES ('', '$eAddress', '$Username', '', '','$pass')");
